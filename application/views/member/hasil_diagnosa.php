...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
      <!-- <a class="navbar-brand" href="index.php"><span>ESC</span>Computer</a> -->
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">
          ...
          <li class="nav-item"><a href="#" class="nav-link"><span>Kategori</span></a></li>
      ...
      <div class="row">
        <div class="col-lg">
          ...
          <div class="page three">
            ...
            <div class="row">
              <h4>Berdasarkan Gejala-Gejala yang telah dipilih,maka singkong anda mengalami:</h4>
              <br>
              ...
              <div class="row d-flex center">
                <div class="col-md-8 d-flex ftco-animate">
                  <div class="blog-entry justify-content-end">
                    <a href="#" class="block-20" style="background-image: url('<?= base_url('assets/images/penyakit/'); ?><?= $det['gambar']; ?>');">
                    </a>
